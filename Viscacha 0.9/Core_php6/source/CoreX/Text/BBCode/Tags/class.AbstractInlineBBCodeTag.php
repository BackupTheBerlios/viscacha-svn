...
/**
 * Abstract implementation for inline BB-Codes.
 *
 * @package		Core
 * @subpackage	Text
 * @author		Matthias Mohr
 ...
 * @since 		1.0
 */
abstract class AbstractInlineBBCodeTag implements BBCodeTag {
