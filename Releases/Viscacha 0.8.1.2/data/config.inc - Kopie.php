...
$config['cryptkey'] = '051835797ec29b6e564ecae2d8a870f2';
$config['database'] = 'test';
$config['dbprefix'] = 'v08_';
$config['dbpw'] = 'root';
...
$config['fname'] = 'Viscacha Dev';
$config['foffline'] = 1;
$config['forenmail'] = 'webmaster@mamo-net.de';
$config['forumzahl'] = 15;
$config['fpath'] = 'D:/Server/htdocs/viscacha/Viscacha 0.8/Core';
$config['ftp_path'] = '';
$config['ftp_port'] = 21;
$config['ftp_pw'] = '';
$config['ftp_server'] = '';
...
$config['furl'] = 'http://127.0.0.1/viscacha/Viscacha 0.8/Core';
$config['gdversion'] = 2;
...
$config['pccron_sendlog_email'] = 'webmaster@mamo-net.de';
