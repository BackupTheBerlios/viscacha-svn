...
$lang['admin_member_set_wildcards'] = 'You can type "%" and "_" as wildcards into the keyword. A "_" replaces one single character, a "%" replaces any characters. The wildcards can only be used with the relational operators <b>!=</b> and <b>=</b>.';
