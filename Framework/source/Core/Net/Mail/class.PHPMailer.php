...
class PHPMailer {
   ...
   * if it cannot load the correct language file.  The default language type
   * is English.
   * @param string $lang_type Type of language (e.g. Portuguese: "br")
   * @access public
   * @return bool
   */
  function SetLanguage($lang_type = 'en') {
    $languages = array(
    	'en' => array (
		...
		'de' => array (
				  'provide_address' => 'Bitte geben Sie mindestens eine Empf&auml;nger Emailadresse an.',
				  'mailer_not_supported' => ' mailer wird nicht unterst&uuml;tzt.',
				  'execute' => 'Konnte folgenden Befehl nicht ausf&uuml;hren: ',
				  'instantiate' => 'Mail Funktion konnte nicht initialisiert werden.',
				  'authenticate' => 'SMTP Fehler: Authentifizierung fehlgeschlagen.',
				  'from_failed' => 'Die folgende Absenderadresse ist nicht korrekt: ',
				  'recipients_failed' => 'SMTP Fehler: Die folgenden Empf&auml;nger sind nicht korrekt: ',
				  'data_not_accepted' => 'SMTP Fehler: Daten werden nicht akzeptiert.',
				  'connect_host' => 'SMTP Fehler: Konnte keine Verbindung zum SMTP-Host herstellen.',
				  'file_access' => 'Zugriff auf folgende Datei fehlgeschlagen: ',
				  'file_open' => 'Datei Fehler: konnte folgende Datei nicht &ouml;ffnen: ',
				  'encoding' => 'Unbekanntes Encoding-Format: ',
				  'signing' => 'Signing Error: ',
				)
    );
    ...
    $this->language = $languages[$lang_type];
    return $return;
  }
