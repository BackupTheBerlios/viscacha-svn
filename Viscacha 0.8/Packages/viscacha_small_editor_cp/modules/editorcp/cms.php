...
function attachWYSIWYG() {
	...
	$r .= 'full.PopupsDir = "editorcp.php?action=cms&job=doc_";';
	$r .= 'full.ImagePopupFile = "editorcp.php?action=cms&job=doc_insert_image&";';
	$r .= 'WYSIWYG.attach("all", full);';
	$r .= '</script>';
	return $r;
}
 ...
 <table class="border" border="0" cellspacing="0" cellpadding="4" align="center">
  ...
  <tr>
   <td class="mbox center">
   	<a class="button" href="editorcp.php?action=cms&amp;job=nav_add"><?php echo $lang->phrase('admin_cms_manage_navigation_add_link'); ?></a>
   	<a class="button" href="editorcp.php?action=cms&amp;job=nav_addbox"><?php echo $lang->phrase('admin_cms_manage_navigation_add_box'); ?></a>
   	<a class="button" href="editorcp.php?action=cms&amp;job=nav_addplugin"><?php echo $lang->phrase('admin_cms_manage_navifation_add_plugin'); ?></a>
   </td>
  </tr>
 </table>
 <br />
<?php
	...
	<?php
	if ($head['active'] == 1) {
		echo '<a href="editorcp.php?action=cms&job=nav_active&id='.$head['id'].iif($head['module'] > 0, '&plug='.$head['module']).'&act=0">'.$lang->phrase('admin_cms_deactivate').'</a>';
	}
	else {
		echo '<a href="editorcp.php?action=cms&job=nav_active&id='.$head['id'].iif($head['module'] > 0, '&plug='.$head['module']).'&act=1">'.$lang->phrase('admin_cms_activate').'</a>';
	}
	?>
	</td>
	<td width="15%"><?php echo $head['ordering']; ?>&nbsp;&nbsp;
	<a href="editorcp.php?action=cms&job=nav_move&id=<?php echo $head['id']; ?>&value=-1"><img src="admin/html/images/asc.gif" border="0" alt="Up"></a>&nbsp;
	<a href="editorcp.php?action=cms&job=nav_move&id=<?php echo $head['id']; ?>&value=1"><img src="admin/html/images/desc.gif" border="0" alt="Down"></a>
	</td>
	<td width="35%">
	 <a class="button" href="editorcp.php?action=cms&job=nav_edit&id=<?php echo $head['id']; ?>"><?php echo $lang->phrase('admin_cms_edit'); ?></a>
	 <a class="button" href="editorcp.php?action=cms&job=nav_delete&id=<?php echo $head['id']; ?>"><?php echo $lang->phrase('admin_cms_delete'); ?></a>
	</td>
	</tr>
	<?php
	if (isset($sub[$head['id']]) && count($sub[$head['id']]) > 0) {
		foreach ($sub[$head['id']] as $link) {
			...
			if (empty($link['link'])) {
				...
				<?php
				if ($link['active'] == 1) {
					echo '<a href="editorcp.php?action=cms&job=nav_active&id='.$link['id'].'&act=0">'.$lang->phrase('admin_cms_deactivate').'</a>';
				}
				else {
					echo '<a href="editorcp.php?action=cms&job=nav_active&id='.$link['id'].'&act=1">'.$lang->phrase('admin_cms_activate').'</a>';
				}
				?>
				</td>
				<td class="mbox" width="15%" nowrap="nowrap" align="center"><?php echo $link['ordering']; ?>&nbsp;&nbsp;
				<a href="editorcp.php?action=cms&job=nav_move&id=<?php echo $link['id']; ?>&value=-1"><img src="admin/html/images/asc.gif" border="0" alt="<?php echo $lang->phrase('admin_cms_move_up'); ?>"></a>&nbsp;
				<a href="editorcp.php?action=cms&job=nav_move&id=<?php echo $link['id']; ?>&value=1"><img src="admin/html/images/desc.gif" border="0" alt="<?php echo $lang->phrase('admin_cms_move_down'); ?>"></a>
				</font></td>
				<td class="mbox" width="25%">
				 <a class="button" href="editorcp.php?action=cms&job=nav_edit&id=<?php echo $link['id'] ?>"><?php echo $lang->phrase('admin_cms_edit'); ?></a>
				 <a class="button" href="editorcp.php?action=cms&job=nav_delete&id=<?php echo $link['id']; ?>"><?php echo $lang->phrase('admin_cms_delete'); ?></a>
				</td>
				</tr>
				<?php
				if (isset($sub[$link['id']]) && count($sub[$link['id']]) > 0) {
					foreach ($sub[$link['id']] as $sublink) {
						...
						if (empty($sublink['link'])) {
							...
							<?php
							if ($sublink['active'] == 1) {
								echo '<a href="editorcp.php?action=cms&job=nav_active&id='.$sublink['id'].'&act=0">'.$lang->phrase('admin_cms_deactivate').'</a>';
							}
							else {
								echo '<a href="editorcp.php?action=cms&job=nav_active&id='.$sublink['id'].'&act=1">'.$lang->phrase('admin_cms_activate').'</a>';
							}
							?>
							</td>
							<td class="mbox" width="15%" nowrap="nowrap" align="right"><?php echo $sublink['ordering']; ?>&nbsp;&nbsp;
							<a href="editorcp.php?action=cms&job=nav_move&id=<?php echo $sublink['id']; ?>&value=-1"><img src="admin/html/images/asc.gif" border="0" alt="<?php echo $lang->phrase('admin_cms_move_up'); ?>"></a>&nbsp;
							<a href="editorcp.php?action=cms&job=nav_move&id=<?php echo $sublink['id']; ?>&value=1"><img src="admin/html/images/desc.gif" border="0" alt="<?php echo $lang->phrase('admin_cms_move_down'); ?>"></a>
							</td>
							<td class="mbox" width="25%">
							 <a class="button" href="editorcp.php?action=cms&job=nav_edit&id=<?php echo $sublink['id']; ?>"><?php echo $lang->phrase('admin_cms_edit'); ?></a>
							 <a class="button" href="editorcp.php?action=cms&job=nav_delete&id=<?php echo $sublink['id']; ?>"><?php echo $lang->phrase('admin_cms_delete'); ?></a>
							</td>
							</tr>
							<?php
						}
...
elseif ($job == 'nav_edit2') {
	...
	$delobj->delete();
	ok('editorcp.php?action=cms&job=nav', $lang->phrase('admin_cms_data_successfully_changed'));
}
...
?>
	...
	<p align="center">
	<a href="editorcp.php?action=cms&job=nav_delete2&id=<?php echo $id; ?>"><img border="0" alt="" src="admin/html/images/yes.gif"> <?php echo $lang->phrase('admin_cms_yes'); ?></a>
	&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;
...
elseif ($job == 'nav_delete2') {
	...
	ok('editorcp.php?action=cms&job=nav', $lang->phrase('admin_cms_entries_deleted'));
}
elseif ($job == 'nav_move') {
	$id = $gpc->get('id', int);
	$pos = $gpc->get('value', int);
	if ($id < 1) {
		error('editorcp.php?action=cms&job=nav', $lang->phrase('admin_cms_invalid_id_given'));
	}
	if ($pos < 0) {
	...
	sendStatusCode(307, $config['furl'].'/editorcp.php?action=cms&job=nav');
}
elseif ($job == 'nav_active') {
	...
	if ($pos != 0 && $pos != 1) {
		error('editorcp.php?action=cms&job=nav', $lang->phrase('admin_cms_invalid_status_specified'));
	}
...
elseif ($job == 'nav_addplugin') {
	...
	$pos = parseNavPosSetting();
	?>
<form name="form" method="post" action="editorcp.php?action=cms&amp;job=nav_addplugin2">
 <table class="border" border="0" cellspacing="0" cellpadding="4" align="center">
  <tr>
...
elseif ($job == 'nav_addplugin2') {
	...
	$delobj = $scache->load('modules_navigation');
	$delobj->delete();
	ok('editorcp.php?action=cms&job=nav', $lang->phrase('admin_cms_plugins_successfully_added'));
}
elseif ($job == 'nav_add') {
	echo head();
	$groups = $db->query("SELECT id, name FROM {$db->pre}groups");
	...
	$pos = parseNavPosSetting();
	?>
<form name="form" method="post" action="editorcp.php?action=cms&job=nav_add2">
 <table class="border" border="0" cellspacing="0" cellpadding="4" align="center">
  <tr>
...
elseif ($job == 'nav_add2') {
	...
	$delobj = $scache->load('modules_navigation');
	$delobj->delete();
	ok('editorcp.php?action=cms&job=nav', $lang->phrase('admin_cms_link_successfully_added'));
}
elseif ($job == 'nav_addbox') {
	...
	$pos = parseNavPosSetting();
	?>
<form name="form" method="post" action="editorcp.php?action=cms&job=nav_addbox2">
 <table class="border" border="0" cellspacing="0" cellpadding="4" align="center">
  <tr>
...
elseif ($job == 'nav_addbox2') {
	...
	$delobj = $scache->load('modules_navigation');
	$delobj->delete();
	ok('editorcp.php?action=cms&job=nav', $lang->phrase('admin_cms_box_successfully_added'));
}
		...
		<tr>
			<td>
			  <?php
				if($dotdotdir) {
					?>
					<a href="editorcp.php?action=cms&job=doc_select_image&dir=<?php echo extract_dir($dir); ?>"><img src="<?php echo $tpl->img('filetypes/folder'); ?>" alt="" border="0" />&nbsp;<em><?php echo $lang->phrase('admin_wysiwyg_prev_dir'); ?></em></a><br>
					<?php
				}
				$i = -1;
				foreach ($dirs as $i => $dirname) {
					?>
					<a href="editorcp.php?action=cms&job=doc_select_image&dir=<?php echo urlencode($dirname); ?>">
...
elseif ($job == 'doc_insert_image') {
	...
	?>
<form method="post" action="editorcp.php?action=cms&amp;job=doc_insert_image&amp;wysiwyg=<?php echo $wysiwyg; ?>" enctype="multipart/form-data">
...
<table class="border" border="0" cellspacing="0" cellpadding="4" align="center" style="width: 700px;">
	...
	<tr class="mbox">
		...
		<td rowspan="8" width="250">
			<iframe id="chooser" height="260" width="250" frameborder="0" src="editorcp.php?action=cms&amp;job=doc_select_image&amp;dir=<?php echo urlencode($dir); ?>"></iframe>
		</td>
	</tr><tr class="mbox">
...
elseif ($job == 'doc') {
	...
	echo head();
?>
<form name="form" method="post" action="editorcp.php?action=cms&job=doc_delete">
 <table class="border" border="0" cellspacing="0" cellpadding="4" align="center">
  <tr>
   <td class="obox" colspan="8">
   <span style="float: right;"><a class="button" href="editorcp.php?action=cms&job=doc_add"><?php echo $lang->phrase('admin_cms_create_new_document'); ?></a></span>
		...
		foreach ($data[$id]['languages'] as $lid => $row2) {
			...
			?>
  			...
  			<?php if ($i == 1) { ?>
   			...
   			<?php } ?>
   			 <td class="mbox"><a href="editorcp.php?action=cms&job=doc_edit&id=<?php echo $id; ?>"><?php echo $row2['title']; ?></a></td>
   			 <td class="mbox stext">
   			<?php
			...
			<?php if ($i == 1) { ?>
			 ...
			 <td class="mbox" rowspan="<?php echo $rowspan; ?>">
			  ...
			  <a class="button" href="editorcp.php?action=cms&job=doc_edit&id=<?php echo $id; ?>"><?php echo $lang->phrase('admin_cms_edit'); ?></a>
			 </td>
			<?php } ?>
			</tr>
<?php
...
?>
  <tr>
   <td class="mbox"><a href="editorcp.php?action=cms&job=doc_add2&type=<?php echo $id; ?>"><?php echo $row['title']; ?></a></td>
...
elseif ($job == 'doc_add2') {
	...
	echo head(' onload="hideLanguageBoxes()"');
  	$groups = $db->query("SELECT id, name FROM {$db->pre}groups");
?>
<form id="form" method="post" action="editorcp.php?action=cms&job=doc_add3&type=<?php echo $type; ?>">
 <table class="border" border="0" cellspacing="0" cellpadding="4" align="center">
  <tr>
...
elseif ($job == 'doc_add3') {
	...
	ok('editorcp.php?action=cms&job=doc', $lang->phrase('admin_cms_document_successfully_added'));
}
elseif ($job == 'doc_delete') {
	...
	if (count($delete) > 0) {
		...
		ok('editorcp.php?action=cms&job=doc', $lang->phrase('admin_cms_documents_deleted'));
	}
	else {
		error('editorcp.php?action=cms&job=doc', $lang->phrase('admin_cms_havent_checked_box'));
	}
}
elseif ($job == 'doc_edit') {
	$id = $gpc->get('id', int);
	...
	if ($db->num_rows($result) == 0) {
		error('editorcp.php?action=cms&job=doc', $lang->phrase('admin_cms_invalid_id_given'));
	}
	$row = $db->fetch_assoc($result);
	...
	echo head(' onload="hideLanguageBoxes()"');
?>
<form id="form" method="post" action="editorcp.php?action=cms&job=doc_edit2&id=<?php echo $id; ?>">
 <table class="border" border="0" cellspacing="0" cellpadding="4" align="center">
  <tr>
...
elseif ($job == 'doc_edit2') {
	...
	if ($db->num_rows($result) == 0) {
		error('editorcp.php?action=cms&job=doc', $lang->phrase('admin_cms_document_doesnt_exist'));
	}
	...
	ok('editorcp.php?action=cms&job=doc', $lang->phrase('admin_cms_document_successfully_changed'));
}
elseif ($job == 'doc_code') {
	echo head();
	$codelang = $scache->load('syntaxhighlight');
